...
prb.createConstraint("foot_vel", v_LF_FOOT) # no vertical velocity of the foot
...
prb.createIntermediateCost("min_q_ddot", cs.sumsqr(q_p_ddot))

# prb.createIntermediateCost("postural",weight_postural_cost*cs.sumsqr(q_p-q_init))
