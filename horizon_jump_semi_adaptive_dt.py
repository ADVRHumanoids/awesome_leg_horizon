...
n_nodes = 100
n_takeoff = 30  # node index at takeoff
n_touchdown = 70  # node index at touchdown
...
dt_res = 0.0001
sol_contact_map = dict(LF_FOOT=solution["f_contact"])  # creating a contact map for applying the input to the foot
...
pyplt.figure()
pyplt.plot(time_vector_res, p_res[1, :])
pyplt.plot(time_vector, solution["q_p"][1, :])
